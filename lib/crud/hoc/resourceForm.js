 ...
 */
function resourceForm(crud, resource) {
  var formToResource = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function (v) {
    return v;
  };
  var resourceToForm = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function (v) {
    return v;
  };
  ...
  return function (WrappedComponent) {
    ...
    var ResourceForm = function (_React$Component) {
      ...
      function ResourceForm() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ResourceForm.__proto__ || Object.getPrototypeOf(ResourceForm)).call.apply(_ref, [this].concat(args))), _this), _this.onSubmit = function (data) {
          ...
          var entity = formToResource(data, _this.props);
          if (_this.props.updatedResource && _this.props.updatedResource[key]) {
            entity[key] = _this.props.updatedResource[key];
            _this.props.updateResource(resource, entity);
          } else {
            _this.props.createResource(resource, entity);
          }
          _this.props.postSubmit && _this.props.postSubmit();
        }, _this.deleteResource = function () {
          var key = resource.key || 'uuid';
          _this.props.deleteResource(resource, _defineProperty({}, key, _this.props.updatedResource[key]));
          _this.props.postSubmit && _this.props.postSubmit();
    ...
    ResourceForm.propTypes = {
      updatedResource: _propTypes2.default.object,
