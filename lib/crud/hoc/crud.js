      ...
      function Crud() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Crud.__proto__ || Object.getPrototypeOf(Crud)).call.apply(_ref, [this].concat(args))), _this), _this.isAuthenticated = function () {
          ...
          promise.then(function (response) {
            _this.props.dispatch(baseActionCreators.fetchSuccess(response.data.data, { replace: replace }));
          }, function (error) {
          ...
          promise.then(function (response) {
            _this.props.dispatch(baseActionCreators.createSuccess(response.data, cid));
          }, function (error) {
          ...
          promise.then(function (response) {
            _this.props.dispatch(baseActionCreators.updateSuccess(response.data));
          }, function (error) {
          ...
          var promise = (0, _axios2.default)({
            url: _this.props.backendUrl + '/' + resource.path + '/' + entity[key],
            method: 'delete',
            headers: { Authorization: _this.props.token }
          });
